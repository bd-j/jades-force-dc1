...
parser.add_argument("--path_psf", type=str,
                    default="/Users/bjohnson/Projects/jades_force/data/psfs/",
                    help="Full path to the PSF image.")
...
if __name__ == "__main__":
    ...
    ans = fit_psfs.psf_mixture(args.path_psf, args.band, nmix=args.ngauss, width=50,
